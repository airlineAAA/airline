...
var flnm = ["Indian Airlines", "Аэрофлот", "Emirates", "Lufthansa", "Singapore Air", "Etihad Airways", "Turkish Airlines", "American Airlines", "Thai Airways", "Qatar Airways"];
var flsrc = ["Дели", "Калькутта", "Мумбаи", "Ченнаи", "Гоа", "Кочин", "Пуна", "Ассам", "Джайпур", "Мумбаи"];
var fldst = ["Лондон", "Москва", "Дубаи", "Берлин", "Сингапур", "Абу-Даби", "Стамбул", "Нью-Йорк", "Бангкок", "Эль-Хаур"];
